...
export const findAllLiveRecordings = async (req, res) => {
  try {
...
export const findAllPastRecordings = async (req, res) => {
  try {
    const recordings = await Recording.find({
      startTime: { $ne: null },
      endTime: { $ne: null },
...
export const findLiveRecordingById = async (req, res) => {
  const { id } = req.params;
  try {
...
export const findPastRecordingById = async (req, res) => {
  const { id } = req.params;
  try {
    const recording = await Recording.findById({
      _id: id,
...
export const findLiveRecordingsByUserId = async (req, res) => {
...
export const findPastRecordingsByUserId = async (req, res) => {
  const { userId } = req.params;
  try {
    const recordings = await Recording.find({
      userId,
